...
const ServiceCeramicPraha: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Keramická ochrana laku Praha | SpectraWash</title>
        <meta
          name="description"
          content="Profesionální keramická ochrana laku v Praze. Dlouhodobá ochrana, hluboký lesk a precizní ruční aplikace ve studiu SpectraWash."
        />
        <link
          rel="canonical"
          href="https://spectrawash.cz/keramicka-ochrana-laku-praha"
        />
      </Helmet>
      ...
      <div className="w-full bg-white pt-[70px] xl:pt-[88px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h2 className="text-3xl font-heading font-bold mb-8 text-brand-dark uppercase tracking-tight">
                  Technologie <span className="text-brand-blue">SiO2</span>
                </h2>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-gray-500 font-light italic">
                "Kvalita keramické ochrany je přímo úměrná kvalitě přípravy povrchu."
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-sm">
                  ...
                  <h3 className="text-xl font-bold mb-4 font-heading uppercase tracking-widest text-brand-dark">
                    {step.title}
                  </h3>
        ...
        <section className="py-24 bg-white border-t border-gray-100">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            <h3 className="text-2xl font-heading font-bold text-brand-dark mb-8 uppercase">
              Údržba keramické ochrany
            </h3>
            ...
            <Button onClick={handleBooking} className="px-16">
              Poptat konzultaci stavu laku
            </Button>
          </div>
        </section>
      </div>
