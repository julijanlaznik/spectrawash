    ...
    <div className="w-full bg-white pt-[70px] xl:pt-[88px]">
      <section className="relative py-24 md:py-40 bg-brand-dark text-white overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <img src="/aplikace-ppf-folie-na-auto.webp" className="w-full h-full object-cover" alt="PPF fólie Praha" />
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <img src="/ppf-folie-auto.webp" className="rounded-2xl shadow-2xl" alt="Aplikace PPF fólie Praha" />
            </div>
            <div>
