...
import { Check, MapPin, Sparkles, Clock, Droplets, ShieldCheck, Wind, Car, Info } from 'lucide-react';
    ...
    <div className="w-full bg-white pt-[70px] xl:pt-[88px]">
      ...
      <section className="relative py-24 md:py-44 bg-brand-dark text-white overflow-hidden">
        <div className="absolute inset-0">
          <img src="/profesionalni-rucni-myti-auta.webp" className="w-full h-full object-cover opacity-20 grayscale" alt="Prémiové ruční mytí aut Praha" />
          <div className="absolute inset-0 bg-gradient-to-t from-brand-dark via-transparent to-transparent"></div>
        </div>
        <div className="container mx-auto px-6 relative z-10 text-center md:text-left">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
            <span className="text-brand-blue font-bold tracking-[0.3em] uppercase text-xs mb-6 block border-l-2 border-brand-blue pl-4">Detailingové studio Roztoky</span>
            <h1 className="text-4xl md:text-7xl font-heading font-bold mb-8 leading-tight uppercase tracking-tighter">
              Profesionální <br/> <span className="text-brand-blue">ruční mytí aut</span>
            </h1>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-3xl font-heading font-bold mb-8 text-brand-dark uppercase tracking-tight">Proč zvolit profesionální <span className="text-brand-blue">detailingové mytí</span>?</h2>
              <div className="space-y-6 text-gray-600 leading-relaxed text-lg font-light">
                <p>
                  Běžné automatické myčky využívají agresivní chemii a rotující kartáče, které na povrchu laku vytvářejí mikro-škrábance, tzv. hologramy. Naše metoda ručního mytí je navržena tak, aby lak čistila hloubkově, ale přitom s maximální šetrností.
                </p>
                <p>
                  Využíváme postupy dekontaminace laku, které odstraní i nečistoty, na které běžné mytí nestačí – náletovou rez, asfalt či organické zbytky. Výsledkem je povrch, který je připraven na následnou aplikaci ochranných vrstev.
                </p>
              </div>
            ...
            <div className="relative">
               <img src="/detailing-exterier.webp" className="rounded-2xl shadow-2xl grayscale-[20%] hover:grayscale-0 transition-all duration-700" alt="Detailing interiéru Praha" />
      ...
      <section className="py-24 bg-brand-light">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
             <h2 className="text-3xl md:text-5xl font-heading font-bold text-brand-dark mb-6 uppercase tracking-tight">Náš procesní standard</h2>
             <p className="text-gray-500 font-light">Každý vůz prochází identickým řetězcem úkonů pro garantovaný výsledek.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, i) => (
              <div key={i} className="p-8 bg-white border border-gray-100 rounded-xl hover:shadow-xl transition-all">
                ...
                <h3 className="text-lg font-bold mb-4 font-heading uppercase tracking-widest text-brand-dark">{step.title}</h3>
         ...
         <div className="container mx-auto px-6">
            <div className="bg-brand-dark rounded-3xl p-8 md:p-16 text-white flex flex-col md:flex-row items-center justify-between gap-10">
               <div className="max-w-xl">
                  <h3 className="text-2xl md:text-4xl font-heading font-bold mb-6 uppercase">Dlouhodobá hodnota vašeho vozu</h3>
                  <p className="text-gray-400 font-light leading-relaxed">
                     Pravidelné ruční mytí v detailingovém standardu udržuje lak v showroomovém stavu. To se projeví nejen na estetice, ale především na zůstatkové ceně vozu při jeho prodeji.
                  </p>
               </div>
               <Button onClick={handleBooking} variant="primary" className="px-12">Poptat termín mytí</Button>
            </div>
         </div>
      </section>
    </div>
