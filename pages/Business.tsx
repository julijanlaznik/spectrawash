         ...
         <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-heading font-bold mb-8 leading-tight">
                Čistá flotila <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">Vaše vizitka</span>
              </h1>
              <p className="text-xl text-gray-400 max-w-xl mb-10 font-light leading-relaxed">
                Reprezentativní vzhled firemních vozů je základ. Nabízíme pravidelné mytí, pick-up servis a individuální ceny pro firmy.
              </p>
      ...
      <section className="py-32 bg-white relative">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border-t border-l border-gray-100">
            {[
              { icon: TrendingUp, title: 'Zachování Hodnoty', desc: 'Pravidelná údržba a mytí zvyšuje zůstatkovou hodnotu vozů.' },
              { icon: Clock, title: 'Pick-up Servis', desc: 'Vůz si vyzvedneme ve vaší firmě a vrátíme dokonale čistý.' },
              { icon: ShieldCheck, title: 'Šetrné Mytí', desc: 'Používáme pouze ruční mytí a kvalitní kosmetiku. Žádné poškrábání z kartáčů.' },
              { icon: Briefcase, title: 'Měsíční Fakturace', desc: 'Přehledné hromadné vyúčtování služeb jednou měsíčně se splatností.' }
            ].map((item, idx) => (
      ...
      <section className="py-24 bg-brand-blue text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between relative z-10">
          <div className="mb-10 md:mb-0 max-w-2xl">
            <h2 className="text-4xl font-heading font-bold mb-4">Máte zájem o spolupráci?</h2>
